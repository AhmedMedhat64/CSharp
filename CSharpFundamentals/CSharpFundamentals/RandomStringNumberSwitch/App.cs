...
namespace CSharpFundamentals.RandomStringNumberSwitch
{
    public class App
    {
        ...
        static void GenerateRandomString(int length)
        {
            ...
            foreach (char c in Included.Distinct())
            {
                ...
                {
                    case '1':
                        ConcatinatedString.Append(CapitalLetters);
                        break;

                    case '2':
                        ConcatinatedString.Append(SmallLetters);
                        break;

                    case '3':
                        ConcatinatedString.Append(Numbers);
                        break;

                    case '4':
                        ConcatinatedString.Append(Symbols);
                        break;
